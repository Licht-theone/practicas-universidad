...
/**
 * Test de una lista con acceso unicamente posicional (no tiene iterador).
 *
 * @author Estructuras de Datos (UC)
 * @version sep-2024
 */
class ListaNoIterTest {

	@Test
	void testConstructor() {
		System.out.println("testConstructor");

		IListaNoIter<String> lst = new ListaDobleEnlaceNoIter<String>(5);
		...
		try {
			lst.obtenElemento(0);
			fail("No excepcion posicion incorrecta");
	...
	void testSuperaCapacidad() {
		...
		IListaNoIter<String> lst = new ListaDobleEnlaceNoIter<String>(capacidadInicial);
		String c;
	...
	void testBusca() {
		...
		IListaNoIter<String> lst = new ListaDobleEnlaceNoIter<String>(7);
	 ...
	 */
	private void muestraLista(IListaNoIter<?> lst) {
		String str = "[";

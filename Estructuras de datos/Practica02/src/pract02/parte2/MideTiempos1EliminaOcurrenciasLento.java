...
/**
 * Programa para medir los tiempos de ejecucion de eliminaOcurrenciasLento().
 * 
 * @author Estructuras de Datos (UC)
 * @version sep-2024
 */
public class MideTiempos1EliminaOcurrenciasLento {
	...
	public static void main(String[] args) {
		...
		for (int i = 0; i < tamanhoEjemplares.length; i++) {
			...
			for (int j = 0; j < NUM_REP_MEDIDA; j++) {
				// algoritmo lento
				EliminaOcurrencias.eliminaOcurrenciasLento(lista1, ELEM_ELIMINAR);
			}
			...
			System.out.printf("  Algoritmo lento:  %8.2fms %n", medidas1[i].ms());
		...
		OperacionesConMedidas.dibujaGrafica(medidas1, "eliminaOcurrenciasLento");
	}

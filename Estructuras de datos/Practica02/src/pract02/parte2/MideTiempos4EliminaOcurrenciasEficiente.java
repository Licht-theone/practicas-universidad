...
/**
 * Programa para medir los tiempos de ejecucion de eliminaOcurrenciasEficiente().
 * 
 * @author Estructuras de Datos (UC)
 * @version sep-2024
 */
public class MideTiempos4EliminaOcurrenciasEficiente {
	...
	public static void main(String[] args) {
		final int NUM_REP_MEDIDA = 40; // veces que se realiza cada medida
		...
		final int[] tamanhoEjemplares =
			{10, 1_000_000, 2_500_000, 3_500_000, 4_500_000, 5_500_000, 6_500_000, 7_500_000};
		...
		for (int i = 0; i < tamanhoEjemplares.length; i++) {
			// crea una lista de numeros aleatorios en el rango [0,RANGO_NUMS-1]
			...
			for (int j = 0; j < NUM_REP_MEDIDA; j++) {
				// algoritmo lento
				EliminaOcurrencias.eliminaOcurrenciasEficiente(lista1, ELEM_ELIMINAR);
			}
			...
			if (tamanhoEjemplares[i] <= TAMANHO_MAX_MOSTRAR) {
				System.out.println("Lista resultado: " + lista1);
			}
		}
		
		// Muestra las medidas obtenidas en una grafica
		OperacionesConMedidas.dibujaGrafica(medidas1, "eliminaOcurrenciasEficiente");
	}

...
public class GUIGestionTarjetas {
	...
	public static void main(String[] args) {
		...
		menu.insertaOpcion("Compra mas cara", COMPRA_MAYOR);
		int opcion;
		...
		while (true) {
			...
			case INFO_COMPRA:
				...
				break;
			case COMPRA_MAYOR:
				Compra c = cadenaTiendas.compraMayorImporte();
				mensaje("Compra mayor", c.producto() + " " + c.importe());
				break;
